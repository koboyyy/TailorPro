...
<div class="max-w-7xl mx-auto space-y-6 pb-10">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
            <h1 class="font-serif text-3xl font-bold text-primary dark:text-white mb-2">Laporan Penjualan</h1>
            <p class="text-grey dark:text-slate-400 text-sm">Pantau performa bisnis dan pertumbuhan pendapatan Anda.</p>
        </div>
        <div class="flex items-center gap-3">
            <button class="flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-xl text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors shadow-sm">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-slate-800 flex flex-col justify-between h-36 relative overflow-hidden group hover:border-gray-300 dark:hover:border-slate-700 transition-colors">
            ...
            <div class="flex items-end justify-between mt-auto z-10">
                <h3 class="font-serif text-[32px] leading-none font-bold text-slate-800 dark:text-white">Rp 48.250.000</h3>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-slate-800 mt-6">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h2 class="font-serif text-lg font-bold text-slate-800 dark:text-white">Tren Pendapatan Bulanan</h2>
                <p class="text-xs text-gray-400 dark:text-slate-400 mt-1">Statistik performa selama 6 bulan terakhir</p>
            </div>
            <div class="flex items-center gap-4 text-xs font-medium text-gray-500 dark:text-slate-400">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-slate-800 mt-6">
        <div class="flex items-center justify-between mb-6">
            <h2 class="font-serif text-lg font-bold text-slate-800 dark:text-white">Transaksi Terakhir</h2>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-sm">
                    <!-- Row 1 -->
                    <tr class="border-b border-gray-50 dark:border-slate-800/50 hover:bg-gray-50/80 dark:hover:bg-slate-800/50 transition-colors">
                        <td class="py-4 px-2 font-bold text-gray-600 dark:text-slate-300">#TX-9021</td>
                        <td class="py-4 px-2">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-bold text-slate-800 dark:text-white">Andi Saputra</span>
                            </div>
                        </td>
                        <td class="py-4 px-2 text-gray-500 dark:text-slate-400">Jas Formal Custom</td>
                        <td class="py-4 px-2 text-gray-400 dark:text-slate-500 font-medium">24 Jun 2024</td>
                        <td class="py-4 px-2 font-bold text-slate-800 dark:text-white">Rp 3.500.000</td>
                        <td class="py-4 px-2">
                    ...
                    <!-- Row 2 -->
                    <tr class="border-b border-gray-50 dark:border-slate-800/50 hover:bg-gray-50/80 dark:hover:bg-slate-800/50 transition-colors">
                        <td class="py-4 px-2 font-bold text-gray-600 dark:text-slate-300">#TX-9020</td>
                        <td class="py-4 px-2">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-bold text-slate-800 dark:text-white">Sarah Wijaya</span>
                            </div>
                        </td>
                        <td class="py-4 px-2 text-gray-500 dark:text-slate-400">Kebaya Modifikasi</td>
                        <td class="py-4 px-2 text-gray-400 dark:text-slate-500 font-medium">23 Jun 2024</td>
                        <td class="py-4 px-2 font-bold text-slate-800 dark:text-white">Rp 2.150.000</td>
                        <td class="py-4 px-2">
                    ...
                    <!-- Row 3 -->
                    <tr class="border-b border-gray-50 dark:border-slate-800/50 hover:bg-gray-50/80 dark:hover:bg-slate-800/50 transition-colors">
                        <td class="py-4 px-2 font-bold text-gray-600 dark:text-slate-300">#TX-9019</td>
                        <td class="py-4 px-2">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-bold text-slate-800 dark:text-white">Kevin Pratama</span>
                            </div>
                        </td>
                        <td class="py-4 px-2 text-gray-500 dark:text-slate-400">Alterasi Celana (4x)</td>
                        <td class="py-4 px-2 text-gray-400 dark:text-slate-500 font-medium">22 Jun 2024</td>
                        <td class="py-4 px-2 font-bold text-slate-800 dark:text-white">Rp 600.000</td>
                        <td class="py-4 px-2">
                    ...
                    <tr class="hover:bg-gray-50/80 dark:hover:bg-slate-800/50 transition-colors">
                        <td class="py-4 px-2 font-bold text-gray-600 dark:text-slate-300">#TX-9018</td>
                        <td class="py-4 px-2">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded-full bg-gray-100 dark:bg-slate-700 border border-gray-200 dark:border-slate-600 flex items-center justify-center text-xs font-bold text-gray-500 dark:text-slate-300">RM</div>
                                <span class="font-bold text-slate-800 dark:text-white">Ria Monica</span>
                            </div>
                        </td>
                        <td class="py-4 px-2 text-gray-500 dark:text-slate-400">Dress Pesta Satin</td>
                        <td class="py-4 px-2 text-gray-400 dark:text-slate-500 font-medium">21 Jun 2024</td>
                        <td class="py-4 px-2 font-bold text-slate-800 dark:text-white">Rp 1.850.000</td>
                        <td class="py-4 px-2">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-[10px] font-bold bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-900/50 tracking-wider">SELESAI</span>
                        </td>
                    </tr>
