...
<body class="h-full flex items-center justify-center bg-[#F4F1EA] dark:bg-background p-6 font-sans">
    ...
    <div class="relative z-10 w-full max-w-md bg-white/80 dark:bg-surface/80 backdrop-blur-md border border-[#EFECE6] dark:border-surface p-8 rounded-3xl shadow-[0_20px_50px_rgba(74,58,42,0.08)] transition-all duration-300">
        ...
        <form action="/register" method="POST" class="space-y-4">
            ...
            <!-- Nama Lengkap -->
            <div>
                <label for="name" class="block text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-1.5">Nama Lengkap</label>
                <div class="relative">
            ...
            <!-- Password -->
            <div>
                <label for="password" class="block text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-1.5">Kata Sandi (Min. 6 Karakter)</label>
                <div class="relative">
                    <span class="absolute inset-y-0 left-4 flex items-center text-gray-400 pointer-events-none text-xs">
            ...
            <!-- Confirm Password -->
            <div>
                <label for="password_confirmation" class="block text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-1.5">Konfirmasi Kata Sandi</label>
                <div class="relative">
                    <span class="absolute inset-y-0 left-4 flex items-center text-gray-400 pointer-events-none text-xs">
