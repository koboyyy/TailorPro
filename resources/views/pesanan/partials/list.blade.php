...
<div id="view-list" class="space-y-6">
    ...
    >
        ...
        >
            Semua
            <span class="font-bold text-[10px] ml-1" id="count-semua">4</span>
        </button>
        <button
        ...
        >
            Menunggu
            <span class="font-bold text-[10px] ml-1" id="count-menunggu">1</span>
        </button>
        <button
        ...
        >
            Pemotongan
            <span class="font-bold text-[10px] ml-1" id="count-pemotongan">1</span>
        </button>
        <button
        ...
        >
            Penjahitan
            <span class="font-bold text-[10px] ml-1" id="count-penjahitan">1</span>
        </button>
        <button
        ...
        >
            Selesai
            <span class="font-bold text-[10px] ml-1" id="count-selesai">0</span>
        </button>
    </div>
