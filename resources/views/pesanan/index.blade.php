                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <span class="block text-[10px] text-gray-400"
                                        >Profil Pelanggan Terpilih</span
                                    >
                                </div>
                            </div>
                            <button
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    id="detail-p-lengan"
                                    disabled
                                    class="w-full pr-12 pl-4 py-3 bg-gray-50/50 dark:bg-slate-855 border border-gray-100 dark:border-slate-800 rounded-2xl text-xs text-secondary dark:text-slate-300"
                                />
                                <span
                                    class="absolute inset-y-0 right-4 flex items-center text-[10px] font-bold text-gray-400"
                                    >CM</span
