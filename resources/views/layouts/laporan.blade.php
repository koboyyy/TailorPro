...
<head>
    ...
    <title>{{ $title ?? 'Laporan - JahitSpace' }}</title>
    ...
    <div class="min-h-full flex flex-col md:flex-row">
        ...
        <header id="global-sidebar" class="hidden md:flex flex-col border-b md:border-b-0 md:border-r border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 md:w-72 md:fixed md:inset-y-0 z-30 transition-all duration-300">
            ...
            <nav class="flex-1 overflow-y-auto px-4 space-y-1">
                ...
                <!-- Dashboard link -->
                <a href="/dashboard" class="group flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-semibold transition-all {{ $default }}">
                    <i class="fas fa-columns w-5"></i>
                    <span>Dashboard</span>
                </a>

                <!-- Ukuran Baju link -->
                <a href="/ukuran-baju" class="group flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-semibold transition-all {{ $default }}">
                    <i class="fas fa-ruler-combined w-5"></i>
                    <span>Ukuran Baju</span>
                </a>

                <!-- Hasilkan Pola link -->
                <a href="#" class="group flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-semibold transition-all {{ $default }}">
                ...
                <!-- Laporan link -->
                <a href="/laporan" class="group flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-semibold transition-all {{ $active }}">
        ...
        <div class="flex-1 md:ml-72">
            <main class="px-4 py-8 sm:px-6 lg:px-8">
                <header class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10 pb-6 border-b border-[#EFECE6]/70 dark:border-slate-800">
                    <!-- Breadcrumbs -->
                    <div class="text-xs text-grey dark:text-slate-400 font-medium tracking-wide">
                        <span>page</span>
                        <span class="mx-2 text-gray-400">/</span>
                        <span class="text-primary dark:text-accent font-semibold">laporan</span>
                    </div>
                    ...
                    <div class="flex items-center gap-4 self-end sm:self-auto">
                        ...
                        <div class="h-8 w-px bg-[#EFECE6] dark:bg-slate-800"></div>

                        <div class="flex items-center gap-3">
                            <span class="text-xs font-semibold text-primary dark:text-accent">Admin</span>
                            <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=100" alt="Admin Profile" class="w-8 h-8 rounded-full object-cover border border-[#EFECE6] dark:border-slate-800">
                        </div>
                    </div>
                </header>
