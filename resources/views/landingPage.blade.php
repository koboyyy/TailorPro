...
<body class="font-sans antialiased text-primary bg-background">
    ...
    <!-- Hero Section -->
    <section class="relative bg-primary pt-32 pb-20 md:pt-48 md:pb-32 px-8 md:px-16 overflow-hidden flex flex-col md:flex-row items-center justify-between">
        <!-- Background Image -->
    ...
    <section id="fitur" class="bg-secondary py-24 px-8 md:px-16">
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Card 1 -->
            <div class="bg-primary border border-secondary rounded-2xl p-8 flex flex-col items-center text-center hover:bg-secondary/40 transition duration-300 group cursor-pointer">
                <div class="w-16 h-16 rounded-full bg-secondary/30 flex items-center justify-center mb-6 group-hover:bg-accent/10 transition">
    ...
    <section id="tentang" class="bg-background py-24 px-8 md:px-16 border-t border-[#EFECE6]">
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16">
            <div class="w-full md:w-5/12">
                <div class="relative">
                    <div class="absolute inset-0 bg-secondary rounded-2xl transform translate-x-4 translate-y-4 opacity-10"></div>
                    <img src="{{ asset('images/tailor_working.png') }}" alt="Tentang TailorPro" class="relative rounded-2xl shadow-xl w-full object-cover aspect-[4/3] md:aspect-square">
                </div>
            </div>
            <div class="w-full md:w-7/12">
                <h2 class="font-serif text-4xl font-bold text-primary mb-2">Tentang Kami</h2>
                <h3 class="text-secondary font-medium text-lg mb-6">TailorPro = Solusi Digital untuk Penjahit & Konveksi Modern</h3>
                
                <div class="space-y-4 text-primary/80 leading-relaxed">
                    <p>
                        TailorPro hadir sebagai aplikasi web pencatatan ukuran baju yang dirancang untuk membantu penjahit, butik, dan konveksi dalam mengelola proses kerja secara lebih mudah, cepat, dan terorganisir.
                    </p>
                    <p>
                        Kami memahami bahwa pencatatan ukuran pelanggan, pengelolaan pesanan, hingga tracking pengerjaan sering kali masih dilakukan secara manual dan berisiko menyebabkan data hilang atau tertukar. Karena itu, TailorPro dibuat untuk memberikan solusi digital yang praktis dan efisien.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white border border-[#EFECE6] rounded-3xl p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition duration-300">
                ...
                <div class="flex-grow">
                    <ul class="space-y-4 text-primary/80 text-sm">
                        <li class="flex items-center gap-3"><i class="fas fa-check-circle text-secondary"></i> Pencatatan ukuran baju</li>
                        <li class="flex items-center gap-3"><i class="fas fa-check-circle text-secondary"></i> Referensi desain baju</li>
                        <li class="flex items-center gap-3"><i class="fas fa-check-circle text-secondary"></i> Simpan data aman</li>
                        <li class="flex items-center gap-3"><i class="fas fa-check-circle text-secondary"></i> Multi devices</li>
                        <li class="flex items-center gap-3"><i class="fas fa-check-circle text-secondary"></i> 100 data pelanggan</li>
                    </ul>
                </div>
                <div class="mt-10">
                    <button class="w-full py-3 rounded-full border-2 border-secondary text-secondary font-medium hover:bg-secondary hover:text-white transition duration-300">Pilih Paket</button>
                </div>
            </div>

            <!-- Pro Plan -->
            <div class="bg-white border-2 border-secondary/20 rounded-3xl p-10 shadow-[0_8px_30px_rgb(0,0,0,0.08)] flex flex-col relative transform md:-translate-y-4 hover:shadow-[0_20px_40px_rgb(0,0,0,0.12)] transition duration-300">
                <div class="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-secondary text-white px-4 py-1 rounded-full text-xs font-bold tracking-wider uppercase">Terpopuler</div>
                <div class="flex flex-col items-center mb-8 border-b border-gray-100 pb-8">
                    <div class="w-12 h-12 rounded-full bg-secondary flex items-center justify-center mb-4 text-white">
                ...
                <div class="flex-grow">
                    <ul class="space-y-4 text-primary/80 text-sm">
                        <li class="flex items-center gap-3"><i class="fas fa-check-circle text-secondary"></i> Pencatatan ukuran baju</li>
                        <li class="flex items-center gap-3"><i class="fas fa-check-circle text-secondary"></i> Hasilkan pola otomatis</li>
                        <li class="flex items-center gap-3"><i class="fas fa-check-circle text-secondary"></i> Referensi desain baju</li>
                        <li class="flex items-center gap-3"><i class="fas fa-check-circle text-secondary"></i> Jadwal pengerjaan</li>
                        <li class="flex items-center gap-3"><i class="fas fa-check-circle text-secondary"></i> Data pelanggan</li>
                        <li class="flex items-center gap-3"><i class="fas fa-check-circle text-secondary"></i> Tracking pengerjaan</li>
                        <li class="flex items-center gap-3"><i class="fas fa-check-circle text-secondary"></i> Simpan data aman</li>
                        <li class="flex items-center gap-3"><i class="fas fa-check-circle text-secondary"></i> Multi devices</li>
                    </ul>
                </div>
                <div class="mt-10">
                    <button class="w-full py-3 rounded-full bg-secondary text-white font-medium hover:bg-primary transition duration-300 shadow-lg shadow-secondary/30">Mulai Berlangganan</button>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-secondary/95 pt-20 pb-10 px-8 md:px-16 border-t border-white/5">
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div class="md:col-span-2">
                ...
                <p class="text-accent/60 text-sm leading-relaxed max-w-sm">
                    TailorPro hadir untuk membantu penjahit, butik, dan konveksi mengelola data pelanggan, ukuran baju, referensi desain, hingga tracking pengerjaan secara lebih praktis dan profesional.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-accent/60 text-sm">
                    <li><a href="#" class="hover:text-accent transition flex items-center gap-2"><i class="fab fa-instagram w-4"></i> Instagram</a></li>
                    <li><a href="#" class="hover:text-accent transition flex items-center gap-2"><i class="fab fa-tiktok w-4"></i> Tiktok</a></li>
                    <li><a href="#" class="hover:text-accent transition flex items-center gap-2"><i class="fab fa-facebook-f w-4"></i> Facebook</a></li>
                </ul>
            </div>
        </div>
        
        <div class="max-w-6xl mx-auto pt-8 border-t border-accent/10 flex flex-col md:flex-row justify-between items-center text-xs text-accent/40">
