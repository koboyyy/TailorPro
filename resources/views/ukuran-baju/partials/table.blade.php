<section class="lg:col-span-2 bg-white dark:bg-slate-900 rounded-2xl border border-[#EFECE6] dark:border-slate-800 shadow-[0_8px_30px_rgb(0,0,0,0.02)] overflow-hidden">
    ...
    <div class="px-6 py-5 border-b border-[#EFECE6]/80 dark:border-slate-800/80 flex justify-between items-center">
        ...
        <button id="filter-btn" class="w-8 h-8 rounded-lg border border-[#EFECE6] dark:border-slate-800 bg-background dark:bg-slate-800 flex items-center justify-center text-xs text-grey dark:text-slate-400 hover:text-primary dark:hover:text-white hover:border-gray-300 dark:hover:border-slate-700 transition">
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-background dark:bg-slate-800/30 border-b border-[#EFECE6]/80 dark:border-slate-800/80 text-[10px] font-bold tracking-wider text-grey dark:text-slate-400 uppercase">
